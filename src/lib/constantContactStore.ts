 ...
 * Upstash for Redis (src/lib/kv.ts) fills that role; it requires the store
 ...
 * form as "Something went wrong" — the same failure mode as before the
 * one-time OAuth setup runs (PROJECT.md §8).
 */
